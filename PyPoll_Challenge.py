...
county_list = []
#Hold county as the key and hold votes cast as the value
county_votes = {}
...
#empty string to hold the name of the county with the most votes
largest_county = ""
#track the county with the most votes, this variable will hold the actual integer
...
with open(file_to_save, "w") as txt_file:
    ...
    largest_county_summary = (
            ...
            f"Number of Votes Cast: {largest_county_count:,}\n"
            f"Percentage of Votes Cast: {largest_county_percentage:.1f}%\n"
            f"-------------------------\n")
